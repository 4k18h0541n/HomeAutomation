...
void setup() {
  ...
  // Connect to WiFi network for esp 8266 use display (ardino serial monotor..)
  Serial.println();
  Serial.println();
...
//digitalWrite(ledPin, value);
 ...
 client.println("</head>");
  ...
  client.println("<h2><center> Home Automation Project Demo(CSE 436) </center></h2>");
  client.println("<h5><center> Project Advisor: Md. Jahir Rafiq  </center></h5>");
  client.println("<h5><center> By: Akib,Topu,Shohel,Ashik  </center></h5>");
  client.println("<hr/><hr>");
